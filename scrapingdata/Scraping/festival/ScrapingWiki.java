...
public class ScrapingWiki extends BaseScrapingFestival{
    public ScrapingWiki(String url) {
        super(url);
    }
    ...
    public void getData() {
        ...
        try(FileWriter writer = new FileWriter("src\\\\main\\\\java\\\\json\\\\festivals_Wiki.json")) {
        	ScrapingManager.setEntityCrawled("Lễ hội - Wikipedia", listTime.size());
            for (int i = 1; i < listTime.size(); i++) {
       ...
       public static void main(String[] args) {
        ...
        ScrapingWiki festivalScraping = new ScrapingWiki(url);
        festivalScraping.getData();
    }
}
